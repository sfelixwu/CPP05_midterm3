...
MT3_Thing.o:	MT3_Thing.cpp MT3_Thing.h
	$(CC) -c $(CFLAGS) MT3_Thing.cpp

Locatable.o:	Locatable.cpp Locatable.h MT3_Thing.h
	$(CC) -c $(CFLAGS) Locatable.cpp

Holdable.o:	Holdable.cpp Holdable.h Locatable.h MT3_Thing.h
	$(CC) -c $(CFLAGS) Holdable.cpp

test_MT3.o:	test_MT3.cpp GPS.h Thing.h Person.h MT3_Thing.h Locatable.h Holdable.h
	$(CC) -c $(CFLAGS) test_MT3.cpp
...
test_MT3:		test_MT3.o GPS.o Labeled_GPS.o Person.o MT3_Thing.o Locatable.o Holdable.o
	g++ -std=c++14 test_MT3.o MT3_Thing.o GPS.o Labeled_GPS.o Person.o Holdable.o Locatable.o -o test_MT3 $(LDFLAGS)
